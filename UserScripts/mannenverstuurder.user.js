// ==UserScript==
// @name                Mannenverstuurder
// @version     	    0.0.1
// @description         mannen versturen op .nl.
// @author              Kont
    ...
    const CommandSender = {
        ...
        init: function () {
            ...
            $($('#command-data-form').find('tbody')[0]).append(
                `<tr>
                    <td>Aankomst:</td><td><input type="datetime-local" id="ACStime" step=".001"></td>
                 </tr>
                 <tr>
                    <td>Delay:</td>
            ...
            this.duration = $('#command-data-form').find('td:contains("Duur:")').next().text().split(':').map(Number);
                    ...
                    ((day, hour, minute, second, millisecond) => {
                        ...
                        (() => {
                            ...
                            worker.onmessage = function () {
                                if (_is_Done) {
                                    UI.Notification.show("https://dsbr.innogamescdn.com/asset/c092731a/graphic/unit/recruit/axe.png", 'Gelukt!', 'Je opdracht is succesvol verzonden');
